...
describe("Edit/Add product", () => {
    ...
    it("should display errors if submitting empty values", () => {
        setup();
    ...
    it("should throw an error if typing NaN in Price input", () => {
        setup();
    ...
    it("should render toast if all field is filled", async () => {
        ...
        const submitBtn = screen.getByTestId("edit-or-add");
        userEvent.click(submitBtn);
        api.post.mockResolvedValue(mockApiData);
        await act(async () => {
    ...
    it("should render the product's details", async () => {
        ...
        const submitBtn = screen.getByTestId("edit-or-add");
        userEvent.click(submitBtn);
        api.put.mockResolvedValue(mockApiData);
        await act(async () => {
            await Promise.resolve();
        });
        await waitFor(
