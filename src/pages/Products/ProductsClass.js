...
export class ProductsClass extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      skip: 0,
  ...
  componentDidMount() {
    api
      .get(`/products?skip=${this.state.skip}&limit=${this.state.limit}`)
      .then(({ data }) => {
          ...
          <div className="row">
            <div className="col-12 position-relative">
              ...
              <div className="d-flex flex-wrap justify-content-around justify-content-xl-start mt-4">
                {!this.props.products ? <Loading /> : productsList}
              </div>
